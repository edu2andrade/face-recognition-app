...
class Signin extends React.Component {
  ...
  onSubmitSignIn = () => {
    fetch("https://ancient-lowlands-42448.herokuapp.com/signin", {
      // 'http://localhost:3000/signin' or 'https://ancient-lowlands-42448.herokuapp.com/signin'
      method: "post",
          ...
          <div className="measure center">
            ...
            <div className="lh-copy mt3">
              <p
                ...
                href="#0"
                className="f6 link dim white-80 underline pointer db"
              >
                Register
              </p>
            </div>
